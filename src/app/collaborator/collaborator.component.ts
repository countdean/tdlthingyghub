import { AfterViewInit, Component, OnInit, Inject, Optional, ViewChild } from '@angular/core';
...
export class CollaboratorComponent implements OnInit, AfterViewInit {
    ...
    dataSource = new MatTableDataSource(collaborators);
...
openDialog(action: string, obj: any) {
    ...
    const dialogRef = this.dialog.open(CollaboratorDialogContent, {
        data: obj
    });
...
updateRowData(row_obj: Collaborator) {
...
deleteRowData(row_obj: Collaborator) {
    this.dataSource.data = this.dataSource.data.filter((value) => {
...
export class CollaboratorDialogContent {
    action: string;
    local_data: any;
    selectedImage:any='';
    joiningDate:any=''
    ...
    constructor(public datePipe:DatePipe,
        public dialogRef: MatDialogRef<CollaboratorDialogContent>,
        // @Optional() is used to prevent error if no data is passed
        @Optional() @Inject(MAT_DIALOG_DATA) public data: Collaborator) {
